...
struct Recepie dessert_recepies_list[14] = {
    ...
    {7, "Gajar Ka Halwa", {"Carrots", "Milk", "Sugar", "Ghee", "Cardamom", "Nuts"}, "Grate carrots and cook with milk until soft. Add sugar, ghee, cardamom, and nuts. Cook until thickened."},
...
struct Recepie breakfast_recepies_list[14] = {
    ...
    {4, "fruit_smoothie", {"banana", "berries", "yogurt", "milk", "honey"}, "Blend banana, berries, yogurt, milk, and honey until smooth."},
    {5, "avocado_toast", {"avocado", "bread", "olive_oil", "salt", "pepper", "lemon_juice", "red_pepper_flakes"}, "Mash avocado with salt, pepper, lemon juice, and red pepper flakes. Spread on toasted bread."},
    {6, "french_toast", {"bread", "eggs", "milk", "cinnamon", "vanilla_extract", "butter"}, "Whisk eggs with milk, cinnamon, and vanilla extract. Dip bread slices in the mixture. Cook in a buttered skillet until golden."},
    {7, "breakfast_burrito", {"tortilla", "eggs", "bacon", "cheese", "salsa", "avocado"}, "Scramble eggs. Fill tortilla with eggs, bacon, cheese, salsa, and avocado. Roll up and serve."},
    {8, "granola_with_yogurt", {"granola", "yogurt", "berries", "honey"}, "Layer granola, yogurt, berries, and honey in a bowl."},
...
struct Recepie dinner_recepies_list[14] = {
    ...
    {6, "lemon_herb_chicken", {"chicken_thighs", "lemon_juice", "rosemary", "thyme", "garlic", "olive_oil", "salt", "pepper"}, "Marinate chicken thighs in lemon juice, rosemary, thyme, garlic, olive oil, salt, and pepper. Bake until golden brown."},
