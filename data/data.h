...
struct Recipe snacks_recipes_list[10] = {
    ...
    {10, "veggie sticks", {"carrots", "celery", "bell pepper", "cucumber", "ranch"}, "Cut carrots, celery, bell pepper, and cucumber into sticks. Serve with ranch dressing for dipping."}};