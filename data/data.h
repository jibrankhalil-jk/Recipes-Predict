...
struct Recipe breakfast_recipes_list[10] = {
    ...
    {5, "avocado toast", {"avocado", "bread", "olive oil", "salt", "pepper", "lemon juice", "red pepper flakes"}, "Mash avocado with salt, pepper, lemon juice, and red pepper flakes. Spread on toasted bread."},
...
struct Recipe dinner_recipes_list[10] = {
    {1, "spaghetti bolognese", {"spaghetti", "ground beef", "onion", "garlic", "tomato sauce", "basil", "oregano", "salt", "pepper"}, "Cook spaghetti. Brown ground beef with onion and garlic. Add tomato sauce, basil, oregano, salt, and pepper. Simmer and serve over spaghetti."},
    ...
    {3, "chicken stir fry", {"chicken breast", "bell pepper", "broccoli", "onion", "soy sauce", "garlic", "ginger", "oil", "rice"}, "Stir-fry chicken, bell pepper, broccoli, and onion in oil. Add soy sauce, garlic, and ginger. Serve over rice."},
    {4, "vegetable lasagna", {"lasagna noodles", "tomato sauce", "ricotta cheese", "mozzarella cheese", "spinach", "zucchini", "onion", "garlic", "oregano", "salt", "pepper"}, "Layer lasagna noodles with tomato sauce, ricotta cheese, mozzarella cheese, spinach, zucchini, onion, garlic, oregano, salt, and pepper. Bake until bubbly."},
    ...
    {7, "shrimp pasta", {"shrimp", "linguine pasta", "garlic", "butter", "parsley", "red pepper flakes", "salt", "pepper"}, "Cook pasta. Sauté shrimp with garlic, butter, parsley, red pepper flakes, salt, and pepper. Toss with cooked pasta."},
    {8, "beef stew", {"beef stew meat", "potatoes", "carrots", "onion", "celery", "beef broth", "tomato paste", "bay leaves", "thyme", "salt", "pepper"}, "Brown beef stew meat. Add potatoes, carrots, onion, celery, beef broth, tomato paste, bay leaves, thyme, salt, and pepper. Simmer until meat is tender."},
    {9, "eggplant parmesan", {"eggplant", "breadcrumbs", "eggs", "marinara sauce", "mozzarella cheese", "parmesan cheese", "basil", "oregano", "salt", "pepper"}, "Coat eggplant in breadcrumbs and eggs. Bake until golden. Layer with marinara sauce, mozzarella cheese, parmesan cheese, basil, oregano, salt, and pepper. Bake until cheese melts."},
...
struct Recipe snacks_recipes_list[10] = {
    ...
    {2, "caprese salad", {"tomato", "mozzarella", "basil", "olive oil", "vinegar", "salt", "pepper"}, "Layer sliced tomatoes, mozzarella, and basil leaves. Drizzle with olive oil and balsamic vinegar. Season with salt and pepper."},
    {3, "hummus", {"chickpeas", "tahini", "lemon juice", "garlic", "olive oil", "cumin", "salt"}, "Blend chickpeas, tahini, lemon juice, garlic, olive oil, cumin, and salt until smooth."},
    {4, "fruit salad", {"apple", "banana", "orange", "grapes", "honey", "lemon juice"}, "Cut fruits into bite-sized pieces. Mix in a bowl. Drizzle with honey and lemon juice. Toss gently to combine."},
    {5, "trail mix", {"almonds", "cashews", "peanuts", "raisins", "chocolate chips"}, "Combine almonds, cashews, peanuts, raisins, and chocolate chips in a bowl. Mix well."},
    ...
    {7, "bruschetta", {"bread", "tomato", "garlic", "basil", "olive oil", "balsamic vinegar", "salt", "pepper"}, "Toast bread slices. Combine diced tomatoes, garlic, basil, olive oil, and balsamic vinegar. Season with salt and pepper. Spoon the mixture onto the toasted bread."},
    {8, "popcorn", {"popcorn kernels", "butter", "salt"}, "Pop popcorn kernels. Melt butter and drizzle it over the popcorn. Sprinkle salt and toss to coat evenly."},
    {9, "cheese plate", {"cheddar cheese", "brie cheese", "crackers", "grapes", "nuts"}, "Arrange cheddar cheese, brie cheese, crackers, grapes, and nuts on a plate."},
    {10, "veggie sticks", {"carrots", "celery", "bell pepper", "cucumber", "ranch dressing"}, "Cut carrots, celery, bell pepper, and cucumber into sticks. Serve with ranch dressing for dipping."}};
